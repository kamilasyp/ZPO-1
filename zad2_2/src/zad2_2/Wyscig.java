...
public class Wyscig implements Runnable {
	...
	static ArrayList<String> tab = CzytanieURL.odczytNazwisk();
	static int kolejnaIteracja = 0;

	static HashMap<Integer, String> czasNazwisko = new HashMap<Integer, String>();
	...
	static String zwracaKolejneNazwisko() {
		String nazwisko = tab.get(kolejnaIteracja);
		kolejnaIteracja += 1;
		return nazwisko;
	}
	...
	public void run() {
		...
		String nazwisko = zwracaKolejneNazwisko();
		...
		if (czasNazwisko.isEmpty())
			...
			// dodaje do tego samego klucza kolejne nazwisko, jesli czasy sie
			// powtarzaja
